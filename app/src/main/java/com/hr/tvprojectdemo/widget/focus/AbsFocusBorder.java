package com.hr.tvprojectdemo.widget.focus;
...
//                    Log.i("@!@!", "point.x="+point.x+" point.y="+point.y);
    ...
    protected void createBorderAnimation(View focusView, Options options) {
        ...
        // FIXME: 2018/3/8  固定
//        final int newWidth = (int) (focusView.getMeasuredWidth()  + paddingWidth + 20);
//        final int newHeight = (int) (focusView.getMeasuredHeight()  + paddingHeight + 20);
